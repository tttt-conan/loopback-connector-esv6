...
var setupMapping = function(mappingType) {
  ...
  // validate that a `mapping` for the `mappingType` has been provided in datasource.<env>.json
  // TODO: key/value pairs in `mappings` where mappingType is the key,
  ...
  mapping.properties.docType = { "type": "keyword", "index": true };
